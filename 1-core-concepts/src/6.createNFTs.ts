...
(async () => {
  ...
  const metadata = {
    ...
    symbol: "PIRATE",
    description:
      "This is a legendary Pirate ship that sails the Seven Seas.",
    image:
  ...
  const metaplex = Metaplex.make(connection)
    ...
    .use(
      // these are not needed on main net
      bundlrStorage({
  ...
  // upload the JSON metadata to file storage network (here arweave is used)
